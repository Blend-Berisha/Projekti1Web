...
<body>
    ...
    <main>
        ...
        <img src="3840x2160-bad-news-eagles-csgo-team-wallpaper-desktop-and-v0-uyfdhaxtehva1.png" class="img1">
    
        <form id="registrationForm" onsubmit="return validateForm()">

            <h2>Register</h2>
    
            <input type="text" id="emri" name="emri" required placeholder="Emri">
      ...
      var emriRegex = /^[a-zA-Z\s]+$/;
      if (!emriRegex.test(emri)) {
        alert('Shtyp Nje Emer Te Vleshem.');
        return false;
      }

      var emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
      if (!emailRegex.test(email)) {
        alert('Ju Lutem Shenoni Nje Email Te Vleshem.');
        return false;
      }

      
      if (password.length < 4) {
        alert('Password-i duhet te jet me i gjat.');
        return false;
      }
      
      window.alert("Jeni regjistruar");
